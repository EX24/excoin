...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EXE features */
        {"excoin", "masternode", &masternode, true, true, false},
        {"excoin", "listmasternodes", &listmasternodes, true, true, false},
        {"excoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"excoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"excoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"excoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"excoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"excoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"excoin", "masternodedebug", &masternodedebug, true, true, false},
        {"excoin", "startmasternode", &startmasternode, true, true, false},
        {"excoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"excoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"excoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"excoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"excoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"excoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"excoin", "mnbudget", &mnbudget, true, true, false},
        {"excoin", "preparebudget", &preparebudget, true, true, false},
        {"excoin", "submitbudget", &submitbudget, true, true, false},
        {"excoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"excoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"excoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"excoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"excoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"excoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"excoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"excoin", "checkbudgets", &checkbudgets, true, true, false},
        {"excoin", "mnsync", &mnsync, true, true, false},
        {"excoin", "spork", &spork, true, true, false},
        {"excoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzexeseed", &getzexeseed, false, false, true},
        {"zerocoin", "setzexeseed", &setzexeseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzexe", &searchdzexe, false, false, true},
        {"zerocoin", "dzexestate", &dzexestate, false, false, true}
...
{
    return "> excoin-cli " + methodname + " " + args + "\n";
}
