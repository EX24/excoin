...
extern UniValue setzexeseed(const UniValue& params, bool fHelp);
extern UniValue getzexeseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzexe(const UniValue& params, bool fHelp);
extern UniValue dzexestate(const UniValue& params, bool fHelp);
