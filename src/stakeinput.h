...
#ifndef EXE_STAKEINPUT_H
#define EXE_STAKEINPUT_H
...
public:
    ...
    virtual bool IszEXE() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zEXEStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zexe, which is a zcspend that has successfully staked
...
public:
    ...
    bool IszEXE() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IszEXE() override { return false; }
};


#endif //EXE_STAKEINPUT_H
