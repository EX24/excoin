                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEXEPathCustom = GetArg("-zexebackuppath", "");
    ...
    if(!strzEXEPathCustom.empty()) {
        ui->wallet_customzexebackuppath->setText(QString::fromStdString(strzEXEPathCustom));
        ui->wallet_customzexebackuppath_label->setVisible(true);
        ui->wallet_customzexebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEXEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EXE RPC console.") + "<br>" +
