...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::EXE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitCoinOneAmount"))
        SoftSetArg("-anonymizeexcoinamount", settings.value("nAnonymizeBitCoinOneAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in excoin.cpp during shotdown to also remove the window positions
