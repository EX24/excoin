...
RESOURCES += src/qt/excoin.qrc src/qt/excoin_locale.qrc

TRANSLATIONS += src/qt/locale/excoin_bg.ts \
                src/qt/locale/excoin_de.ts \
                src/qt/locale/excoin_en.ts \
                src/qt/locale/excoin_es.ts \
                src/qt/locale/excoin_fi.ts \
                src/qt/locale/excoin_fr.ts \
                src/qt/locale/excoin_it.ts \
                src/qt/locale/excoin_ja.ts \
                src/qt/locale/excoin_pl.ts \
                src/qt/locale/excoin_pt.ts \
                src/qt/locale/excoin_ru.ts \
                src/qt/locale/excoin_sk.ts \
                src/qt/locale/excoin_sv.ts \
                src/qt/locale/excoin_vi.ts \
                src/qt/locale/excoin_zh_CN.ts \
                src/qt/locale/excoin_zh_TW.ts
