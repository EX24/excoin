...
#   c) node1 mines 32 blocks, so now node 0 has 60001exo, node 1 has 4250exo, node2 has none.
#   d) node0 sends 601 exo to node2, in two transactions (301 exo, then 300 exo).
