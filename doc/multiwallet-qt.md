...
In order to support loading of multiple wallets in excoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is excoin.cpp.
...
Changes to excoin.cpp
----------------------
excoin.cpp is the entry point into excoin-qt, and as such, will require some minor modifications to provide hooks for
