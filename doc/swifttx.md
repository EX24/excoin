...
This mechanism has been integrated into Bitcore-Node-EXE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EXE-Project/insight-api-excoin#web-socket-api](https://github.com/EXE-Project/insight-api-excoin#web-socket-api) 
* API: [https://github.com/EXE-Project/insight-api-excoin#swifttx-transactions](https://github.com/EXE-Project/insight-api-excoin#swifttx-transactions) 
...
By default, the Excoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Excoin Core daemon:
