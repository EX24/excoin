Contributing to Excoin Core
============================

The Excoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Excoin Core project, and is not to be
confused with overall EXE Network Protocol consensus changes.

Whether a pull request is merged into Excoin Core rests with the project merge
...
Patches that change EXE consensus rules are considerably more involved than
...
Where a patch set proposes to change the EXE consensus, it must have been
...
The project leader is the release manager for each Excoin Core release.
